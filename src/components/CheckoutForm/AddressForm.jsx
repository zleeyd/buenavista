...
const AddressForm = ({ checkoutToken, test }) => {
  ...
  return (
    <>
      <Typography variant="h6" gutterBottom>Datos de compra</Typography>
        ...
        <form onSubmit={methods.handleSubmit((data) => test({ ...data, shippingCountry, shippingSubdivision, shippingOption }))}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={6}>
              <InputLabel>País de compra</InputLabel>
            ...
            <Grid item xs={12} sm={6}>
              <InputLabel>Estado de compra</InputLabel>
            ...
            <Grid item xs={12} sm={6}>
              <InputLabel>Optciones de compra</InputLabel>
